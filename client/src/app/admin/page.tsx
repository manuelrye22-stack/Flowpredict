                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`px-2 py-1 rounded text-xs font-medium ${w.network === 'LTC' ? 'bg-orange-100 text-orange-700' : 'bg-blue-100 text-blue-700'}`}>
                            {w.network === 'LTC' ? 'LTC' : 'USDT'}
                          </span>
                        </div>
                        <div className="mt-2">
                      ...
                      <div className="flex flex-col gap-2 ml-4">
                        {w.network === 'LTC' ? (
                          <button
                            onClick={() => {
                              if (confirm(`Auto-send ${w.amount} USDT equivalent in LTC to ${w.address.substring(0, 15)}...?`)) {
                                handleProcessWithdrawal(w._id, 'approve', 'auto')
                              }
                            }}
